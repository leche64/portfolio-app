    ...
    <div>
      ...
      <main>
        ...
        <motion.nav
          ...
          className="text-black p-8 mb-6 flex justify-between select-none md:p-12 md:mb-0"
        >
        ...
        <motion.div
          ...
          className="text-black text-center p-10 md:px-20 lg:px-40 snap-y snap-mandatory overflow-scroll"
        >
